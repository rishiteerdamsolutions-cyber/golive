...
function ConnectVercelForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      const res = await fetch("/api/connect/vercel", {
        method: "POST",
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-bold mb-2">Connect Vercel</h1>
      <p className="text-slate-400 mb-6">
        ...
        and paste it below. We&apos;ll use it to deploy your projects.
      </p>
